...
class HxClass {
	...
	public function __construct ($phpClassName) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:622: characters 3-35
	...
	public function __call ($method, $args) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:630: characters 3-111
		$callback = ((($this->phpClassName === "String" ? HxString::class : $this->phpClassName))??'null') . "::" . ($method??'null');
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:631: characters 3-53
	...
	public function __get ($property) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:639: lines 639-647
		if (defined("" . ($this->phpClassName??'null') . "::" . ($property??'null'))) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:640: characters 4-54
			return constant("" . ($this->phpClassName??'null') . "::" . ($property??'null'));
		} else if (Boot::hasGetter($this->phpClassName, $property)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:642: characters 29-41
			$tmp = $this->phpClassName;
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:642: characters 4-59
			return $tmp::{"get_" . ($property??'null')}();
		} else if (method_exists($this->phpClassName, $property)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:644: characters 4-48
			return new HxClosure($this->phpClassName, $property);
		} else {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:646: characters 33-45
			$tmp1 = $this->phpClassName;
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:646: characters 4-56
	...
	public function __set ($property, $value) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:655: lines 655-659
		if (Boot::hasSetter($this->phpClassName, $property)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:656: characters 22-34
			$tmp = $this->phpClassName;
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:656: characters 4-59
			$tmp::{"set_" . ($property??'null')}($value);
		} else {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:658: characters 26-38
			$tmp1 = $this->phpClassName;
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:658: characters 4-56
			$tmp1::${$property} = $value;
		}
	}
}
